...
import { setCreateArticle, setUpdateArticle, setLoading, setTitleError  } from '../../redux/actions';
...
function NewArticle({location, match}) {
    ...
    const titleError  = useSelector(state => state.blogData.titleError)
    let obj;
                                ...
                                <div className = {classes.formContainer}>
                                    <label className = {classes.formLabel}>Title
                                        <input className = {classes.formInput} placeholder="Title"
                                            {...register('title', {required: "Title is required", onChange: () => onChangeTitle()})}/>
                                            {errors.title?.type === 'required' ? (<p className = {classes.danger}>{errors.title.message}</p>) : 
                                                titleError ? <p className = {classes.danger}>{titleError}</p> : ''}
                                    </label>
                                </div>
                                <div className = {classes.formContainer}>
